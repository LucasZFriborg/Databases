-- Många gånger när någon kund eller kollega vill ha hjälp att få ut data ur en databas så har de ingen aning om vilka specifika kolumner
-- eller tabeller datan är lagrad i. Då får man hjälpa till med lite detektivarbete. Om databasen är någorlunda välstrukturerad kan man
-- oftast, utifrån namnen, gissa sig till vad de olika tabellerna innehåller och hur de är relaterade.

-- Vid det här laget har ni de flesta verktyg ni behöver för att skriva queries och få ut den information ni letar efter. Nu är det dags att
-- börja gräva runt bland data i everyloop för att hitta svar på specifika frågor.
...
-- 1. Företagets totala produktkatalog består av 77 unika produkter. Om vi kollar bland våra ordrar, hur stor andel av dessa produkter
-- har vi någon gång levererat till London?
...
-- Skriv sedan en SELECT-sats som tar ut alla låtar från den lista som angivits i @playlist efter följande exempel: (Se bild i pdf-filen)
